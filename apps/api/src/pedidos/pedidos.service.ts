...
export class PedidosService {
  ...
  // A regra vive no PrecoService (a OS também precisa dela); aqui fica só a
  // porta de entrada que a tela de pedidos já usa.
  async getPreco(clienteId: number, servicoId: number) {
    return this.preco.getPreco(clienteId, servicoId);
  }
